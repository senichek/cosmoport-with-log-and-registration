...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/scriptsOfLoginPage.js">
    </script>

</head>


    <h1 style="text-align: center; margin-top: 50px; margin-bottom: 30px">Spaceship rating login page </h1>


<div class="col text-center">
    <button style="margin-top: 15px; margin-left: 15px" type="button" class="btn btn-info " onclick="clickCreate()">Login</button>
</div>
<br>
    <form style="background-color: #E9ECEF; padding: 20px; border-radius: 10px; display: none" id="createButton">
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputUsernameNew">Username</label>
                <input type="text" class="form-control" id="inputUsernameNew" placeholder="Username">
            </div>
            <div class="form-group col-md-6">
                <label for="inputPasswordNew">Password</label>
                <input type="text" class="form-control" id="inputPasswordNew" placeholder="Password">
            </div>
        </div>
